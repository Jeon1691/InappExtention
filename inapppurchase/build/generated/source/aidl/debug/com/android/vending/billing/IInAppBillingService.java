 ...
 * Original file: /Users/jeonseung-il/Dropbox/AndroidProjects/TestInAppPurchase/inapppurchase/src/main/aidl/com/android/vending/billing/IInAppBillingService.aidl
 */
 ...
 * 2. The purchaseItem flow is synchronous and purchaseItem information is available immediately
 *    after it completes.
 ...
 * RESULT_ITEM_ALREADY_OWNED = 7 - Failure to purchaseItem since item is already owned
...
/**
     ...
     *         "DETAILS_LIST" with a StringArrayList containing purchaseItem information
...
/**
     * Returns a pending intent to launch the purchaseItem flow for an in-app item by providing a SKU,
     * the type, a unique purchaseItem token and an optional developer payload.
     * @param apiVersion billing API version that the app is using
     * @param packageName package name of the calling app
     * @param sku the SKU of the in-app item as published in the developer console
     * @param type the type of the in-app item ("inapp" for one-time purchases
     *        and "subs" for subscription).
     * @param developerPayload optional argument to be sent back with the purchaseItem information
     * @return Bundle containing the following key-value pairs
     *         "RESPONSE_CODE" with int value, RESULT_OK(0) if success, other response codes on
     *              failure as listed above.
     *         "BUY_INTENT" - PendingIntent to start the purchaseItem flow
     *
     * The Pending intent should be launched with startIntentSenderForResult. When purchaseItem flow
     * has completed, the onActivityResult() will give a resultCode of OK or CANCELED.
     * If the purchaseItem is successful, the result data will contain the following key-value pairs
     *         "RESPONSE_CODE" with int value, RESULT_OK(0) if success, other response codes on
     *              failure as listed above.
     ...
     *         "INAPP_DATA_SIGNATURE" - String containing the signature of the purchaseItem data that
...
/**
     ...
     *         "INAPP_PURCHASE_DATA_LIST" - StringArrayList containing the purchaseItem information
